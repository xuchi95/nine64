...
DECLARE
  ...
  standard_fen text := 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKQBNR w KQkq - 0 1';
BEGIN
...
DROP FUNCTION IF EXISTS public.create_online_match(uuid, text, boolean);
...
REVOKE ALL ON FUNCTION public.find_match(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.find_match(uuid) TO service_role;